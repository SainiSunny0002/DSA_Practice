...
public class MinimizeMaxDistance_BetweenGasStations {
    //brute force approach TC O(k*n) + O(n) SC O(n-1)
...
//    }
    ...
    //better approach TC O(nlogn + klogn) SC O(n-1)+O(n-1)
...
//    }
    ...
    public static void main(String[] args) {
        int arr[] = {1,13,17,23};
        int k = 5;
        System.out.print(minimiseMaxDistance(arr, k));
    }
}
